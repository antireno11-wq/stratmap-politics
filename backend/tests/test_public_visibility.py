...
class PublicVisibilityTests(unittest.TestCase):
    ...
    def test_current_period_row_with_attendance_coverage_stays_visible(self) -> None:
        row = {"periodo": "2026-2030", "votes_expected_total": None, "sesiones_totales": 105, "asistencia_pct": 100.0}
        self.assertFalse(db._is_new_without_historical_baseline(row, reference_year=2026))
